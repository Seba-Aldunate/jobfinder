  ...
  return (
    <div>
      ...
      <Menu as="div" className="inline-block text-left">
          ...
          <Menu.Button className="inline-flex gap-2 w-full rounded-md bg-white md:px-4 py-2 text-sm font-medium text-slate-700 hover:bg-opacity-20 ">
            <div className="leading[80px] flex flex-col items-start">
              <p className="text-sm font-semibold ">
                {/* si el usuario existe, muestra el primer nombre */}
                {user?.firstName ?? user?.name}
              </p>
              {/* si es user muestra jobtitle o email si es una compañía */}
        ...
        >
          {/* Elementos del menú */}
          <Menu.Items className="absolute z-50 right-2 mt-2 w-56 otigin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg focus:outline-none">
            <div className="p-1">
              {/* Elemento del menú: Perfil de usuario o perfil de compañía */}
              <Menu.Item>
                {({ active }) => (
                  <Link
                    // Segun tipo de cuenta reenvia al perfil correspondinte
                    to={`${
    ...
    <>
      <div className="relative bg-[#f7fdfd] z-50">
        <nav className="container mx-auto flex items-center justify-between p-5">
          ...
          {/* Botón de inicio de sesión o menú desplegable de usuario */}
